...
# 12 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/../device_config.h"
...
# 12 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/../device_config.h" 2
...
# 13 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/../device_config.h" 2
...
# 15 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/../device_config.h" 2
# 25 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/../device_config.h"
...
# 26 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
   GPIO_LOW = 0,
   GPIO_HIGH
}logic_t;
...
static Std_ReturnType lcd_4bit_set_cursor(const lcd_4bit_t *lcd, uint8 row, uint8 colomn){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if(((void*)0) != lcd && row <= 2 && colomn <= 20){
        colomn--;
        switch(row){
            case 1: ret = lcd_4bit_send_command(lcd, (0x80 + colomn)); break;
            case 2: ret = lcd_4bit_send_command(lcd, (0xc0 + colomn)); break;
            default: break;
        }
    }
    return ret;
