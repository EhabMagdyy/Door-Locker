...
# 12 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/../device_config.h"
...
# 12 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/../device_config.h" 2
...
# 13 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/../device_config.h" 2
...
# 15 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/../device_config.h" 2
# 25 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/../device_config.h"
...
# 26 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
   GPIO_LOW = 0,
   GPIO_HIGH
}logic_t;
...
Std_ReturnType motor_intialize(const motor_t* motor){
    ...
    if(((void*)0) != motor){
        ...
        ret = gpio_pin_intialize(&motor->motor_pin[0x00]);
        ret = gpio_pin_intialize(&motor->motor_pin[0x01]);
    }
    return ret;
}
# 34 "ECU_Layer/DC_Motor/ecu_dc_motor.c"
Std_ReturnType motor_move_right(const motor_t* motor){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if(((void*)0) != motor){
        ret = (Std_ReturnType)0x01;
        ret = gpio_pin_write_logic(&motor->motor_pin[0x00], GPIO_HIGH);
        ret = gpio_pin_write_logic(&motor->motor_pin[0x01], GPIO_LOW);
    }
    return ret;
}
# 51 "ECU_Layer/DC_Motor/ecu_dc_motor.c"
Std_ReturnType motor_stop(const motor_t* motor){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if(((void*)0) != motor){
        ret = (Std_ReturnType)0x01;
        ret = gpio_pin_write_logic(&motor->motor_pin[0x00], GPIO_LOW);
        ret = gpio_pin_write_logic(&motor->motor_pin[0x01], GPIO_LOW);
    }
    return ret;
}
