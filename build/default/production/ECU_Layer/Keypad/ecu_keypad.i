...
# 12 "ECU_Layer/Keypad/../../MCAL_Layer/GPIO/../device_config.h"
...
# 12 "ECU_Layer/Keypad/../../MCAL_Layer/GPIO/../device_config.h" 2
...
# 13 "ECU_Layer/Keypad/../../MCAL_Layer/GPIO/../device_config.h" 2
...
# 15 "ECU_Layer/Keypad/../../MCAL_Layer/GPIO/../device_config.h" 2
# 25 "ECU_Layer/Keypad/../../MCAL_Layer/GPIO/../device_config.h"
...
# 26 "ECU_Layer/Keypad/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
   GPIO_LOW = 0,
   GPIO_HIGH
}logic_t;
...
typedef struct{
    ...
    pin_config_t keypad_coloumns_pins[3];
}keypad_t;
...
static const uint8 keypad_matrix[4][3] = {
                                                        {'1','2','3'},
                                                        {'4','5','6'},
                                                        {'7','8','9'},
                                                        {'*','0','#'}
...
Std_ReturnType keypad_intialize(const keypad_t *keypad){
    ...
    if(((void*)0) != keypad){
        ...
        for(int rows_counter = 0 ; rows_counter < 4 ; rows_counter++){
